...
using static SeralythTemp.Classes.RigManager;
    ...
    public class Safety
    {
        ...
        public static void AntiReport(System.Action<VRRig, Vector3> onReport)
        {
            ...
            foreach (GorillaPlayerScoreboardLine line in GorillaScoreboardTotalUpdater.allScoreboardLines)
            {
                ...
                foreach (var vrrig in from vrrig in RigManager.vrrigs where !vrrig.isLocal let D1 = Vector3.Distance(vrrig.rightHandTransform.position, report.position) let D2 = Vector3.Distance(vrrig.leftHandTransform.position, report.position) where D1 < 0.35f || D2 < 0.35f select vrrig)
